...
def get_args(description: str) -> Namespace:
    ...
    parser.add_argument(
        "-U", "--update", metavar="steam_user", help="update server and/or mods"
    )
    parser.add_argument(
        "-s", "--update-server", action="store_true", help="update server"
    )
    parser.add_argument(
        "-m", "--update-mods", action="store_true", help="update the server's mods"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-I", "--installed-mods", action="store_true", help="list installed mods"
    )
    parser.add_argument(
        "-T",
        "--shutdown",
    ...
    parser.add_argument(
        "-B", "--backup", nargs="*", metavar="mission", help="backup the server"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-e", "--message", metavar="template", help="RCon countdown message template"
    )
    parser.add_argument(
        "-t",
        "--countdown",
